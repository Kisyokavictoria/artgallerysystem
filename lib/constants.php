...
class Constants
{
  ...
  public static $config = array(
    ...
    "CallBackURL"      => "https://95ca-41-90-181-86.ngrok-free.app/art/lib/callback.php", //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "GO DOWN ART",
