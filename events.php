        ...
        <div class="container">
            ...
            <div class="title-wrapper">
                ...
                <ul class="filter-btn-list">
                    ...
                    <li class="filter-btn-item">
                        <button class="filter-btn" data-filter-btn="accessory">Photography</button>
                    </li>

                    <li class="filter-btn-item">
                        <button class="filter-btn" data-filter-btn="decoration">Sculptures</button>
                    </li>

                    <li class="filter-btn-item">
                        <button class="filter-btn" data-filter-btn="furniture">Paintings</button>
                    </li>

                    <li class="filter-btn-item">
                        <button class="filter-btn" data-filter-btn="furniture">Drawings</button>
                    </li>
                    <li class="filter-btn-item">
                        <button class="filter-btn" data-filter-btn="furniture">Printmaking</button>
                    </li>
