...
$mysql = new Mysql();
$art_result_sculpters = $mysql->selectwhere('art','category','=',Art_Type::sculpture);
...
<body id="top">
 ...
 -->
    ...
    if ($art_result_sculpters) {
      // Loop through each artwork and generate HTML for product container
      while ($artwork = mysqli_fetch_assoc($art_result_sculpters)) {
    ?>
  ...
  <script src="../assets/script/app.js"></script>
    ...
    <!-- <section class="section product" id="shop" aria-label="product">
        ...
        <h2 class="h2 section-title" style="margin-top: 100px;">
                <span class="span">Sculptures</span>
            </h2>
